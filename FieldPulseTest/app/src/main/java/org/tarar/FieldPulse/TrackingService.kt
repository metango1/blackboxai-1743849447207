...
class TrackingService : Service() {
    ...
    private var trackingController: org.tarar.FieldPulse.TrackingController? = null
    ...
    override fun onCreate() {
        ...
        try {
            ...
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
                ...
                trackingController = org.tarar.FieldPulse.TrackingController(this)
    ...
    companion object {
        ...
        const val ACTION_STARTED = "org.tarar.FieldPulse.SERVICE_STARTED"
        const val ACTION_STOPPED = "org.tarar.FieldPulse.SERVICE_STOPPED"
