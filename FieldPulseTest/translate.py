...
organization = transifex_api.Organization.get(slug='FieldPulse')
project = organization.fetch('projects').get(slug='FieldPulse')
resource = project.fetch('resources').get(slug='FieldPulse')
